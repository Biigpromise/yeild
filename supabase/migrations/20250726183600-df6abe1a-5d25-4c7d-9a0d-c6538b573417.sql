-- Phase 1: Security and Performance Optimization (Targeted)

-- Add missing constraints only for existing columns
DO $$ 
BEGIN 
...
-- Phase 2: Critical Performance Indexes for High-Traffic Tables
...
-- Optimize profiles table for leaderboard and user lookups
...
-- Optimize user_roles for authentication checks
...
-- Optimize posts and social features
