      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 space-y-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
            {allRanks.map((rank) => {
              const isUnlocked = operatorStats && 
                operatorStats.verified_executions >= rank.min_verified_executions &&
                operatorStats.execution_success_rate >= rank.min_success_rate;
