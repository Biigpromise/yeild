...
import { ArrowLeft, FileText, Plus, Save, Eye, Clock, Star, Tag } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="border-border">
              <CardHeader>
                <CardTitle className="text-foreground">Social Media Integration (Optional)</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {Object.entries(formData.socialMediaLinks).map(([platform, url]) => (
                    <div key={platform}>
                      <Label htmlFor={platform} className="text-foreground capitalize">{platform}</Label>
                      <Input
                        id={platform}
                        value={url}
