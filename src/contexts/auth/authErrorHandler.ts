...
export const handleAuthError = (error: any, operation: string): string => {
  ...
  const errorMessages: { [key: string]: string } = {
    ...
    'Password should be at least 6 characters': 'Password must be at least 8 characters long with uppercase, lowercase, and numbers.',
    'Password is too short': 'Password must be at least 8 characters long with uppercase, lowercase, and numbers.',
    ...
    'over_email_send_rate_limit': 'Too many email attempts. Please wait a few minutes before trying again.',
    ...
    'Cannot resend verification to a user that already registered': 'This email is already registered. Try signing in instead.',
    'Signups not allowed for this instance': 'Signups are currently disabled. Please contact support.',
    'Email link is invalid or has expired': 'The link is invalid or has expired. Please request a new one.',
    'Edge Function returned a non-2xx status code': 'There was an issue with our service. Please try again in a few moments.',
