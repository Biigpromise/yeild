      ...
      case 2:
        return (
          <div className="text-center space-y-6">
            ...
            <div>
              <h2 className="text-xl font-bold mb-4 text-white">Complete Tasks</h2>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg border border-white/10">
                ...
                <Badge variant="secondary" className="bg-yeild-yellow/20 text-yeild-yellow border-0">Easy</Badge>
              </div>
              <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg border border-white/10">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-yeild-yellow/20 rounded-full flex items-center justify-center">
                ...
                <Badge variant="secondary" className="bg-yeild-yellow/20 text-yeild-yellow border-0">Medium</Badge>
              </div>
              <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg border border-white/10">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-yeild-yellow/20 rounded-full flex items-center justify-center">
                  ...
                  <span className="text-sm text-white">App Testing</span>
                </div>
                <Badge variant="secondary" className="bg-yeild-yellow/20 text-yeild-yellow border-0">Advanced</Badge>
              </div>
            </div>
          </div>
        );
      ...
      case 3:
        return (
          <div className="text-center space-y-6">
            ...
            <div>
              <h2 className="text-xl font-bold mb-4 text-white">Earn Points</h2>
              <p className="text-white/80 mb-6">
            ...
            <div className="bg-white/5 p-6 rounded-lg border border-white/10">
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <span className="text-sm text-white/60">points per task</span>
              </div>
      ...
      case 4:
        return (
          <div className="text-center space-y-6">
            ...
            <div>
              <h2 className="text-xl font-bold mb-4 text-white">Unlock Rewards</h2>
              <p className="text-white/80 mb-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-white/5 rounded-lg border border-white/10">
                ...
                <p className="text-sm font-medium text-white">Cash Rewards</p>
      ...
      case 5:
        return (
          <div className="text-center space-y-6">
            ...
            <div>
              <h2 className="text-xl font-bold mb-4 text-white">Join the Community</h2>
              <p className="text-white/80 mb-6">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-white/5 rounded-lg border border-white/10">
                <p className="text-sm font-medium mb-2 text-white">Community Features</p>
          ...
          <div className="text-center space-y-6">
            ...
            <div className="bg-white/5 p-4 rounded-lg border border-white/10">
              <p className="text-sm text-white/80">
                <strong className="text-yeild-yellow">Tip:</strong> Complete your first task to unlock the referral system and earn even more rewards!
              </p>
            </div>
          </div>
        );
