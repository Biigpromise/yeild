...
export const BirdStatusDisplay: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="w-full p-4 bg-gray-800/50">
  ...
  if (error) {
    return (
      <div className="w-full p-4 bg-red-900/20">
  ...
  return (
    <>
      <div className="w-full bg-gradient-to-br from-purple-900/20 via-blue-900/20 to-green-900/20 border-b border-purple-500/30">
        <motion.div
